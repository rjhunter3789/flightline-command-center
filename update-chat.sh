#!/bin/bash
  ...
  echo "=== Updating Flightline Chat System ==="
  ...
  # Create chat handlers file
  cat > backend/src/websocket/chatHandlers.js << 'EOF'
  ...
  REACT_APP_API_URL=http://146.190.39.214:3001
  REACT_APP_WS_URL=http://146.190.39.214:3001
  EOF
  ...
  echo "=== Chat Update Complete ==="
  echo "Check: http://146.190.39.214:8080"
